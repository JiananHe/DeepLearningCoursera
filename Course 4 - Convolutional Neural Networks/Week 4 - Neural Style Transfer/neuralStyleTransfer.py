...
def compute_content_cost(a_C, a_G):
    ...
    # print(a_G_unrolled.get_shape()) # if a_G is (1, 4, 5, 3), then a_G_unrolled is (3, 5, 4, 1)
...
def compute_style_cost(model, STYLE_LAYERS):
    ...
    for layer_name, ceoff in STYLE_LAYERS:
...
if __name__=="__main__":
    ...
    # load content image
    content_image = scipy.misc.imread("images/meal.jpg")
    ...
    # load style image
    style_image = scipy.misc.imread("images/van_gogh_star0_style.jpg")
